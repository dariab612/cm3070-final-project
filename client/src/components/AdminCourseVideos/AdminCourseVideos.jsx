  ...
  return (
    <>
      ...
      <div className="course-videos-main-page">
        ...
        courseContentList.map(courseContent => <AdminCourseContentCard id={courseContent.id} title={courseContent.title} link={courseContent.link} courseId={courseContent.courseId}/>)
